...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "A collection of some neat repositories.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%77%7A%6D%61%74%74.%77%6F%72%6B@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/weezymatt", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/wzmatth", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://huggingface.co/weezygeezer", "_blank");
        },
      },{
      id: 'light-theme',
